...
def init_db():
    ...
    try:
        from . import (
            ...
            risk_analysis_tables, hazmat_tables, tunnel_tables, asset_cost_tables,  # 新增模块
            failure_prediction_tables,
            auth_tables, notification_tables, assistant_tables,
        )
    except ImportError:
        import workorder_tables, plan_tables
        import risk_analysis_tables, hazmat_tables, tunnel_tables, asset_cost_tables
        import failure_prediction_tables
        import auth_tables, notification_tables, assistant_tables
