...
const ALERT_ROWS = [
  ['001', '燃气浓度异常', 'RED', '高风险', 'GAS-001', '燃气浓度探测器', '中心城区', 109.2308, 36.5752, '待处理', '8.6%', 20, 45, 32],
  ['002', '燃气泄漏预警', 'RED', '高风险', 'GAS-002', '燃气泄漏探测器', '中心城区', 109.2127, 36.5598, '处理中', '4.2%LEL', 20, 43, 18],
  ['003', '供水压力异常', 'ORANGE', '较高风险', 'WTR-001', '供水压力传感器', '东北片区', 109.2471, 36.5584, '待处理', '0.18MPa', 20, 42, 6],
  ['004', '管网压力异常', 'ORANGE', '较高风险', 'GAS-003', '燃气压力传感器', '东南片区', 109.2642, 36.5385, '处理中', '0.31MPa', 20, 40, 24],
  ['005', '道路沉降异常', 'YELLOW', '中风险', 'CAM-001', '道路监控摄像机', '西南片区', 109.1987, 36.5446, '待处理', '18mm', 20, 38, 11],
  ['006', '井盖状态异常', 'YELLOW', '中风险', 'MH-001', '智能井盖', '中心城区', 109.2378, 36.5279, '处理中', '倾角 12°', 20, 36, 45],
  ['007', '设备通讯异常', 'BLUE', '低风险', 'SEN-004', '管网通讯终端', '西北片区', 109.1838, 36.5815, '待处理', '中断 3min', 20, 35, 20],
  ['008', '供水遥测信号波动', 'BLUE', '低风险', 'WTR-002', '供水遥测终端', '东北片区', 109.2733, 36.5768, '已处理', '丢包率 6%', 20, 32, 8]
]
